...
export default function Header({route}) {
  ...
  return (
      <LazyMotion features={domAnimation}>
        ...
        >
          <Link href="/">
            <a className={`fixed top-0 left-0 m-[20px] md:m-[20px] block w-[65px] md:w-[90px] transition-colors ease-in-out duration-300 z-40 overflow-hidden hover:text-burnt-yellow group ${route == '/wayfinder' ? '' : ''}`}>
              <m.div variants={revealHoriReverse} className="pr-1">
