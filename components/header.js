...
export default function Header() {
  return (
    <header className="flex flex-wrap fixed items-start z-30 top-0 left-0 right-0 w-full p-[20px]">
      <Link href="/">
        <a className="block w-[48px] md:w-[64px] hover:-rotate-45 transition ease-in-out duration-300">
      ...
      <Link href="/wayfinder">
        <a className="ml-auto hover:outline-none focus:outline-none block w-[48px] md:w-[64px] group py-3">
