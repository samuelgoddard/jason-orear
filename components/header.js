...
export default function Header({route}) {
  ...
  return (
      <LazyMotion features={domAnimation}>
        ...
        >
          <Link href="/">
            <a className={`fixed top-0 left-0 m-[20px] block w-[48px] md:w-[48px] hover:-rotate-45 transition ease-in-out duration-300 z-40 overflow-hidden ${route == '/wayfinder' || route == '/info' ? '' : 'hover:text-pink'}`}>
