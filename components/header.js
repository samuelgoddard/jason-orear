...
export default function Header({route}) {
  return (
    <header className="">
      <Link href="/">
        <a className={`fixed top-0 left-0 m-[20px] block w-[48px] md:w-[48px] hover:-rotate-45 transition ease-in-out duration-300 z-40 ${route == '/wayfinder' || route == '/info' ? '' : 'hover:text-pink'}`}>
      ...
      <Link href="/wayfinder">
        <a className="fixed top-0 right-0 m-[20px] ml-auto hover:outline-none focus:outline-none block w-[48px] md:w-[64px] group py-3 z-40 group">
          <span className={`origin-top-left transition ease-in-out duration-300 block w-full h-1 bg-black mb-3 group-hover:scale-x-75 ${route == '/wayfinder' || route == '/info' ? '' : 'group-hover:bg-pink'}`}></span>

          <span className={`origin-top-left transition ease-in-out duration-300 block w-8/12 h-1 bg-black group-hover:scale-x-50 ${route == '/wayfinder' || route == '/info' ? '' : 'group-hover:bg-pink'}`}></span>
        </a>
      </Link>
    </header>
  )
