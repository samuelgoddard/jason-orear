...
export default function Header({route}) {
  ...
  return (
      <LazyMotion features={domAnimation}>
        ...
        >
          <Link href="/">
            <a className={`fixed top-0 left-0 m-[14px] md:m-[20px] block w-[38px] md:w-[48px] hover:-rotate-45 transition ease-in-out duration-300 z-40 overflow-hidden ${route == '/wayfinder' || route == '/info' ? '' : ''}`}>
