...
export default function App({ Component, pageProps }) {
  ...
  return (
    <>
      ...
      <div className={`scroll-conainer transition-colors ease-in-out duration-700 delay-[400ms] ${router.asPath === '/info' || router.asPath === '/wayfinder' ? 'bg-pink' : '' }`}>
              ...
              { !introContext && router.asPath == '/' && (
                ...
                >
                  ...
                  <div className="flex flex-wrap absolute bottom-0 left-0 right-0 mb-5">
                    <span className="w-full text-[18px] md:text-[22px] tracking-tight ml-auto leading-none uppercase text-center block">
